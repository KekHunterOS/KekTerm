...
import com.team420.kekterm.compat.ActionBarCompat;
import com.team420.kekterm.compat.ActivityCompat;
import com.team420.kekterm.compat.AndroidCompat;
import com.team420.kekterm.compat.MenuItemCompat;
import com.team420.kekterm.emulatorview.EmulatorView;
import com.team420.kekterm.emulatorview.TermSession;
import com.team420.kekterm.emulatorview.UpdateCallback;
import com.team420.kekterm.emulatorview.compat.ClipboardManagerCompat;
import com.team420.kekterm.emulatorview.compat.ClipboardManagerCompatFactory;
import com.team420.kekterm.emulatorview.compat.KeycodeConstants;
import com.team420.kekterm.util.PermissionCheck;
import com.team420.kekterm.util.SessionList;
import com.team420.kekterm.util.TermSettings;
...
public class Term extends Activity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener, View.OnClickListener {
    ...
    public static final String EXTRA_WINDOW_ID = "com.team420.kekterm.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "com.team420.kekterm.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "com.team420.kekterm.broadcast.PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "com.team420.kekterm.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "com.team420.kekterm.permission.PREPEND_TO_PATH";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.team420.kekterm:TermDebug.LOG_TAG");
    ...
    private void NotFound(String text){
        ...
        if (Objects.equals(text, "/data/data/com.team420.kekhunter/files/scripts/bootkali")){
