...
package com.team420.kekterm.emulatorview;

import com.team420.kekterm.emulatorview.compat.AndroidCompat;
...
import com.team420.kekterm.emulatorview.compat.Patterns;
...
public class EmulatorView extends View implements GestureDetector.OnGestureListener {
    ...
    private void commonConstructor(Context context) {
        ...
        origPrefTextSize = Integer.parseInt(context.getSharedPreferences("com.team420.kekterm_preferences", Context.MODE_PRIVATE).getString("fontsize", String.valueOf((int) 13)));
    }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            if (canSetText) {
                getRootView().getContext().getSharedPreferences("com.team420.kekterm_preferences", Context.MODE_PRIVATE).edit().putString("fontsize", String.valueOf(tempPrefTextSize)).apply();
